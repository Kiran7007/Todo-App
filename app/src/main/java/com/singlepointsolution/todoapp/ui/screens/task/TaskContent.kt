...
import com.singlepointsolution.todoapp.ui.theme.SMALL_PADDING
...
fun TaskContent(
    ...
    Column(
        ...
        Divider(
            modifier = Modifier.height(SMALL_PADDING), color = MaterialTheme.colors.background
        )
        Button(
...
private fun TaskContentPreview() {
    TaskContent(note = "", onNoteChange = {}, onAddButtonClick = {})
}